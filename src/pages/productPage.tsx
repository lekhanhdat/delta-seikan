    ...
    <div>
      ...
      <div className="space-y-20 py-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div
          ...
          style={{ scrollMarginTop: "calc(var(--header-height) + 20px)" }}
        >
          <ProductSection
        ...
        {/* 2. DRD */}
        <div ref={setRef(1)} className="scroll-mt-[calc(var(--header-height)+20px)]">
          <ProductSection
        ...
        {/* 3. LON 3 MẢNH */}
        <div ref={setRef(2)} className="scroll-mt-[calc(var(--header-height)+20px)]">
          <ProductSection
            title="Lon 3 mảnh"
        ...
        {/* 4. NẮP EOE */}
        <div ref={setRef(3)} className="scroll-mt-[calc(var(--header-height)+20px)]">
          <ProductSection
            title="Nắp EOE"
        ...
        {/* 5. PACKAGING */}
        <div ref={setRef(4)} className="scroll-mt-[calc(var(--header-height)+20px)]">
          <ServiceSection
